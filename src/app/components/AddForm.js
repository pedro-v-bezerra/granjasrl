...
export default function AddForm() {
  const { validarDados, addGranja, setSelectedAdd } = useContext(GranjaContext);
  ...
  const formatPhoneNumber = (phone) => {
    ...
    // Se a string estiver vazia, não faz nada
      ...
      <div className="px-6 py-8 lg:px-40">
        ...
        <div>
          <div className="flex items-center">
            <div onClick={() => setSelectedAdd(false)}>
              <Image src="/back.svg" width={30} height={30} alt="Adicionar" className="cursor-pointer mb-2 md:w-12 md:h-12" />
            </div>
          </div>
          <h1 className="font-bold text-[#753233] text-3xl md:text-3xl">Adicionar Granjas</h1>
